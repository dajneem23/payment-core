    ...
    get jwtConfig() {
        return {
            ...
            privateKey: readFileSync(
                this.get('JWT_PRIVATE_KEY_PATH') || 'keys/jwt-private.pem',
                'utf8',
            ),
            publicKey: readFileSync(
                this.get('JWT_PUBLIC_KEY_PATH') || 'keys/jwt-public.pem',
                'utf8',
            ),
            accessExpiresIn: this.getNumber('JWT_ACCESS_EXPIRES_IN') || 900,
            refreshExpiresIn: this.getNumber('JWT_REFRESH_EXPIRES_IN') || 604800,
            issuer: this.get('JWT_ISSUER') || 'vietpay-user-service',
            audience: this.get('JWT_AUDIENCE') || 'vietpay',
        };
    }
